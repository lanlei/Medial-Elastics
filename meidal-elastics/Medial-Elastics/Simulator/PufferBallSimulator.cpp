...
namespace MECR
{
	...
	bool PufferBallSimulator::loadSceneFromConfig(const std::string filename, TiXmlElement* header_item)
	{
		...
		if (header_item && item_name == std::string("simulator"))
		{
			...
			while (sub_item)
			{
				...
				{
					PufferBallConfig* mc = new PufferBallConfig();
		...
		std::string box_filename = scene_path + "scene_box.obj";
		readDrawBoxFromObjFile(box_filename);
		return true;
	}

	bool PufferBallSimulator::loadSceneFromBinary(std::ifstream& fb)
	{
		uint32_t size;
		...
		STLContainerIO::read_one_level_vector(fb, host_surface_sphere_point_collision_floor_stiffness);
		...
		STLContainerIO::read_one_level_vector(fb, host_tet_volume_constraint_weight);
		...
		fb.read((char*)&host_total_tet_volume_constraint_tet_num, sizeof(uint32_t));
		STLContainerIO::read_one_level_vector(fb, host_tet_volume_constraint_tet_list);
		...
		STLContainerIO::read_one_level_vector(fb, host_tet_nodes_velocity);
		...
		STLContainerIO::read_two_level_vector(fb, host_each_sphere_gravity_force);
		STLContainerIO::read_two_level_vector(fb, host_each_sphere_init_velocity);
		...
		STLContainerIO::read_two_level_vector(fb, host_sys_project_matrix_csrRowPtr);
		STLContainerIO::read_two_level_vector(fb, host_sys_project_matrix_csrColInd);
		STLContainerIO::read_two_level_vector(fb, host_sys_project_matrix_csrVal);
		STLContainerIO::read_one_level_vector(fb, host_sys_project_matrix_nonZero);

		STLContainerIO::read_two_level_vector(fb, host_sys_project_matrix_t_csrRowPtr);
		STLContainerIO::read_two_level_vector(fb, host_sys_project_matrix_t_csrColInd);
		STLContainerIO::read_two_level_vector(fb, host_sys_project_matrix_t_csrVal);
		STLContainerIO::read_one_level_vector(fb, host_sys_project_matrix_t_nonZero);

		STLContainerIO::read_one_level_vector(fb, host_total_sys_project_matrix_csrRowPtr);
		STLContainerIO::read_one_level_vector(fb, host_total_sys_project_matrix_csrColInd);
		STLContainerIO::read_one_level_vector(fb, host_total_sys_project_matrix_csrVal);
		fb.read((char*)&host_total_sys_project_matrix_nonZero, sizeof(int));
		STLContainerIO::read_one_level_vector(fb, host_total_sys_project_matrix_t_csrRowPtr);
		STLContainerIO::read_one_level_vector(fb, host_total_sys_project_matrix_t_csrColInd);
		STLContainerIO::read_one_level_vector(fb, host_total_sys_project_matrix_t_csrVal);
		fb.read((char*)&host_total_sys_project_matrix_t_nonZero, sizeof(int));
		...
		/////////////////////////////
		fb.read((char*)&host_total_branch_num, sizeof(uint32_t));
		STLContainerIO::read_one_level_vector(fb, host_branch_num);
		STLContainerIO::read_one_level_vector(fb, host_branch_offset);
		STLContainerIO::read_one_level_vector(fb, host_total_surface_faces_self_collision_culling_flag);
		STLContainerIO::read_one_level_vector(fb, host_total_surface_points_self_collision_culling_flag);
		STLContainerIO::read_one_level_vector(fb, host_total_surface_faces_ref_branch_list);
		STLContainerIO::read_one_level_vector(fb, host_tet_nodes_on_sphere_list);
		//
		///////////////////////////
		fb.read((char*)&draw_box_points_num, sizeof(uint32_t));
		fb.read((char*)&draw_box_faces_num, sizeof(uint32_t));
		STLContainerIO::read_one_level_vector(fb, draw_box_points_position);
		STLContainerIO::read_one_level_vector(fb, draw_box_faces_index);
		EigenMatrixIO::read_binary(fb, draw_box_color);

		load_from_binary = true;
		return true;
	}

	void PufferBallSimulator::saveSceneAsBinary(std::ofstream& fb)
	{
		uint32_t size;
		...
		STLContainerIO::write_one_level_vector(fb, host_surface_sphere_point_collision_floor_stiffness);
		...
		STLContainerIO::write_one_level_vector(fb, host_tet_volume_constraint_weight);
		...
		fb.write((char*)&host_total_tet_volume_constraint_tet_num, sizeof(uint32_t));
		STLContainerIO::write_one_level_vector(fb, host_tet_volume_constraint_tet_list);
		...
		STLContainerIO::write_one_level_vector(fb, host_tet_nodes_velocity);
		...
		STLContainerIO::write_two_level_vector(fb, host_each_sphere_gravity_force);
		STLContainerIO::write_two_level_vector(fb, host_each_sphere_init_velocity);
		...
		STLContainerIO::write_two_level_vector(fb, host_sys_project_matrix_csrRowPtr);
		STLContainerIO::write_two_level_vector(fb, host_sys_project_matrix_csrColInd);
		STLContainerIO::write_two_level_vector(fb, host_sys_project_matrix_csrVal);
		STLContainerIO::write_one_level_vector(fb, host_sys_project_matrix_nonZero);

		STLContainerIO::write_two_level_vector(fb, host_sys_project_matrix_t_csrRowPtr);
		STLContainerIO::write_two_level_vector(fb, host_sys_project_matrix_t_csrColInd);
		STLContainerIO::write_two_level_vector(fb, host_sys_project_matrix_t_csrVal);
		STLContainerIO::write_one_level_vector(fb, host_sys_project_matrix_t_nonZero);

		STLContainerIO::write_one_level_vector(fb, host_total_sys_project_matrix_csrRowPtr);
		STLContainerIO::write_one_level_vector(fb, host_total_sys_project_matrix_csrColInd);
		STLContainerIO::write_one_level_vector(fb, host_total_sys_project_matrix_csrVal);
		fb.write((char*)&host_total_sys_project_matrix_nonZero, sizeof(int));
		STLContainerIO::write_one_level_vector(fb, host_total_sys_project_matrix_t_csrRowPtr);
		STLContainerIO::write_one_level_vector(fb, host_total_sys_project_matrix_t_csrColInd);
		STLContainerIO::write_one_level_vector(fb, host_total_sys_project_matrix_t_csrVal);
		fb.write((char*)&host_total_sys_project_matrix_t_nonZero, sizeof(int));
		...
		////
		/////////////////////////////
		fb.write((char*)&host_total_branch_num, sizeof(uint32_t));
		STLContainerIO::write_one_level_vector(fb, host_branch_num);
		STLContainerIO::write_one_level_vector(fb, host_branch_offset);
		STLContainerIO::write_one_level_vector(fb, host_total_surface_faces_self_collision_culling_flag);
		STLContainerIO::write_one_level_vector(fb, host_total_surface_points_self_collision_culling_flag);
		STLContainerIO::write_one_level_vector(fb, host_total_surface_faces_ref_branch_list);
		STLContainerIO::write_one_level_vector(fb, host_tet_nodes_on_sphere_list);

		///////////////////////////
		fb.write((char*)&draw_box_points_num, sizeof(uint32_t));
		fb.write((char*)&draw_box_faces_num, sizeof(uint32_t));
		STLContainerIO::write_one_level_vector(fb, draw_box_points_position);
		STLContainerIO::write_one_level_vector(fb, draw_box_faces_index);
		EigenMatrixIO::write_binary(fb, draw_box_color);
	}

	void PufferBallSimulator::initSimulator()
	{
	...
	void PufferBallSimulator::transferToCudaBuffer()
	{
		...
		cudaMalloc((void**)&dev_surface_faces_bbox, sizeof(qeal) * host_surface_faces_bbox.size());
		cudaMemcpy(dev_surface_faces_bbox, host_surface_faces_bbox.data(), sizeof(qeal) * host_surface_faces_bbox.size(), cudaMemcpyHostToDevice);
		...
		cudaMalloc((void**)&dev_surface_points_face_list, sizeof(uint32_t) * host_surface_points_face_list.size());
		cudaMemcpy(dev_surface_points_face_list, host_surface_points_face_list.data(), sizeof(uint32_t) * host_surface_points_face_list.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_surface_points_face_buffer_offset, sizeof(uint32_t) * host_surface_points_face_buffer_offset.size());
		cudaMemcpy(dev_surface_points_face_buffer_offset, host_surface_points_face_buffer_offset.data(), sizeof(uint32_t) * host_surface_points_face_buffer_offset.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_surface_points_face_num, sizeof(uint32_t) * host_surface_points_face_num.size());
		cudaMemcpy(dev_surface_points_face_num, host_surface_points_face_num.data(), sizeof(uint32_t) * host_surface_points_face_num.size(), cudaMemcpyHostToDevice);
		...
		cudaMalloc((void**)&dev_surface_sphere_point_collision_floor_stiffness, sizeof(qeal) * host_surface_sphere_point_collision_floor_stiffness.size());
		cudaMemcpy(dev_surface_sphere_point_collision_floor_stiffness, host_surface_sphere_point_collision_floor_stiffness.data(), sizeof(qeal) * host_surface_sphere_point_collision_floor_stiffness.size(), cudaMemcpyHostToDevice);
		...
		cudaMalloc((void**)&dev_medial_cones_bbox, sizeof(qeal) * host_medial_cones_bbox.size());
		cudaMemcpy(dev_medial_cones_bbox, host_medial_cones_bbox.data(), sizeof(qeal) * host_medial_cones_bbox.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_medial_slabs_bbox, sizeof(qeal) * host_medial_slabs_bbox.size());
		cudaMemcpy(dev_medial_slabs_bbox, host_medial_slabs_bbox.data(), sizeof(qeal) * host_medial_slabs_bbox.size(), cudaMemcpyHostToDevice);
		...
		cudaMalloc((void**)&dev_enlarge_primitives_for_show, sizeof(qeal) * (host_total_medial_cones_num + host_total_medial_slabs_num));

		cudaMalloc((void**)&dev_dist_surface_point_to_mp, sizeof(qeal) * host_total_surface_points_num);

		// sim
		cudaMalloc((void**)&dev_total_fullspace_dim, sizeof(uint32_t));
		cudaMemcpy(dev_total_fullspace_dim, &host_total_fullspace_dim, sizeof(uint32_t), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_total_reduce_dim, sizeof(uint32_t));
		cudaMemcpy(dev_total_reduce_dim, &host_total_reduce_dim, sizeof(uint32_t), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_total_fullspace_dim_zero_vector, sizeof(qeal) * host_total_fullspace_dim);
		cudaMalloc((void**)&dev_total_reduce_dim_zero_vector, sizeof(qeal) * host_total_fullspace_dim);

		cudaMalloc((void**)&dev_fullspace_dim, sizeof(uint32_t) * host_fullspace_dim.size());
		cudaMemcpy(dev_fullspace_dim, host_fullspace_dim.data(), sizeof(uint32_t) * host_fullspace_dim.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_fullspace_dim_buffer_offset, sizeof(uint32_t) * host_fullspace_dim_buffer_offset.size());
		...
		cudaMalloc((void**)&dev_reduce_dim, sizeof(uint32_t) * host_reduce_dim.size());
		cudaMemcpy(dev_reduce_dim, host_reduce_dim.data(), sizeof(uint32_t) * host_reduce_dim.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_reduce_dim_buffer_offset, sizeof(uint32_t) * host_reduce_dim_buffer_offset.size());
		...
		cudaMalloc((void**)&dev_handles_type, sizeof(uint32_t) * host_handles_type.size());
		cudaMemcpy(dev_handles_type, host_handles_type.data(), sizeof(uint32_t) * host_handles_type.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_handles_buffer_offset, sizeof(uint32_t) * host_handles_buffer_offset.size());
		...
		cudaMalloc((void**)&dev_tet_strain_constraint_weight, sizeof(qeal) * host_tet_strain_constraint_weight.size());
		...
		cudaMalloc((void**)&dev_tet_volume_constraint_weight, sizeof(qeal) * host_tet_volume_constraint_weight.size());
		cudaMemcpy(dev_tet_volume_constraint_weight, host_tet_volume_constraint_weight.data(), sizeof(qeal) * host_tet_volume_constraint_weight.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_tet_stc_project_list, sizeof(uint32_t) * host_tet_stc_project_list.size());
		...
		cudaMalloc((void**)&dev_tet_stc_project_buffer_offset, sizeof(uint32_t) * host_tet_stc_project_buffer_offset.size());
		...
		cudaMalloc((void**)&dev_tet_stc_project_buffer_num, sizeof(uint32_t) * host_tet_stc_project_buffer_num.size());
		...
		cudaMalloc((void**)&dev_tet_DrMatirx_inv, sizeof(qeal) * host_tet_DrMatrix_inv.size());
		cudaMemcpy(dev_tet_DrMatirx_inv, host_tet_DrMatrix_inv.data(), sizeof(qeal) * host_tet_DrMatrix_inv.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_tet_R_matrix, sizeof(qeal) * host_tet_R_matrix.size());
		cudaMemcpy(dev_tet_R_matrix, host_tet_R_matrix.data(), sizeof(qeal) * host_tet_R_matrix.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_total_tet_volume_constraint_tet_num, sizeof(uint32_t) );
		cudaMemcpy(dev_total_tet_volume_constraint_tet_num, &host_total_tet_volume_constraint_tet_num, sizeof(uint32_t), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_tet_volume_constraint_tet_list, sizeof(uint32_t) * host_tet_volume_constraint_tet_list.size());
		cudaMemcpy(dev_tet_volume_constraint_tet_list, host_tet_volume_constraint_tet_list.data(), sizeof(uint32_t) * host_tet_volume_constraint_tet_list.size(), cudaMemcpyHostToDevice);
		//
		cudaMalloc((void**)&dev_inertia_y, sizeof(qeal) * host_total_fullspace_dim);

		cudaMalloc((void**)&dev_Ms_n, sizeof(qeal) * host_total_fullspace_dim);

		cudaMalloc((void**)&dev_mass_vector, sizeof(qeal) * host_total_fullspace_dim);
		cudaMemcpy(dev_mass_vector, host_mass_vector.data(), sizeof(qeal) * host_mass_vector.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_mass_inv_vector, sizeof(qeal) * host_total_fullspace_dim);
		cudaMemcpy(dev_mass_inv_vector, host_mass_inv_vector.data(), sizeof(qeal) * host_mass_inv_vector.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_ori_b, sizeof(qeal) * host_ori_b.size());
		cudaMemcpy(dev_ori_b, host_ori_b.data(), sizeof(qeal) * host_ori_b.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_fullspace_displacement, sizeof(qeal) * host_total_fullspace_dim);

		cudaMalloc((void**)&dev_reduce_displacement, sizeof(qeal) * host_total_fullspace_dim);

		cudaMalloc((void**)&dev_tet_nodes_ori_position, sizeof(qeal) * host_total_fullspace_dim);
		...
		cudaMalloc((void**)&dev_tet_nodes_prev_position, sizeof(qeal) * host_total_fullspace_dim);
		...
		cudaMalloc((void**)&dev_project_elements_position, sizeof(qeal) * 12 * host_total_tet_elements_num);

		cudaMalloc((void**)&dev_project_nodes_position, sizeof(qeal) * host_total_fullspace_dim);

		cudaMalloc((void**)&dev_tet_nodes_velocity, sizeof(qeal) * host_tet_nodes_velocity.size());
		cudaMemcpy(dev_tet_nodes_velocity, host_tet_nodes_velocity.data(), sizeof(qeal) * host_tet_nodes_velocity.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_tet_nodes_force, sizeof(qeal) * host_total_fullspace_dim);

		cudaMalloc((void**)&dev_tet_nodes_gravity_force, sizeof(qeal) * host_tet_nodes_gravity_force.size());
		...
		cudaMalloc((void**)&dev_tet_nodes_extra_force, sizeof(qeal) * host_tet_nodes_extra_force.size());
		...
		host_each_sphere_has_shot.resize(host_objectives_num, false);
		host_shoot_shpere = -1;

		dev_each_sphere_gravity_force.resize(host_each_sphere_gravity_force.size());
		for (uint32_t i = 0; i < dev_each_sphere_gravity_force.size(); i++)
		{
			cudaMalloc((void**)&dev_each_sphere_gravity_force[i], sizeof(qeal) * host_each_sphere_gravity_force[i].size());
			cudaMemcpy(dev_each_sphere_gravity_force[i], host_each_sphere_gravity_force[i].data(), sizeof(qeal) * host_each_sphere_gravity_force[i].size(), cudaMemcpyHostToDevice);
		}

		dev_each_sphere_init_velocity.resize(host_each_sphere_init_velocity.size());
		for (uint32_t i = 0; i < dev_each_sphere_gravity_force.size(); i++)
		{
			cudaMalloc((void**)&dev_each_sphere_init_velocity[i], sizeof(qeal) * host_each_sphere_init_velocity[i].size());
			cudaMemcpy(dev_each_sphere_init_velocity[i], host_each_sphere_init_velocity[i].data(), sizeof(qeal) * host_each_sphere_init_velocity[i].size(), cudaMemcpyHostToDevice);
		}
		...
		cudaMalloc((void**)&dev_surface_points_force, sizeof(qeal) * 3 * host_total_surface_points_num);

		cudaMalloc((void**)&dev_surface_points_floor_collision_force, sizeof(qeal) * 3 * host_total_surface_points_num);

		cudaMalloc((void**)&dev_surface_dim_zero_vector, sizeof(qeal) * 3 * host_total_surface_points_num);
		...
		dev_sys_project_matrix_csrRowPtr.resize(host_objectives_num);
		dev_sys_project_matrix_csrColInd.resize(host_objectives_num);
		dev_sys_project_matrix_csrVal.resize(host_objectives_num);
		dev_sys_project_matrix_t_csrRowPtr.resize(host_objectives_num);
		dev_sys_project_matrix_t_csrColInd.resize(host_objectives_num);
		dev_sys_project_matrix_t_csrVal.resize(host_objectives_num);

		cudaMalloc((void**)&dev_sys_project_matrix_nonZero, sizeof(int) * host_sys_project_matrix_nonZero.size());
		cudaMemcpy(dev_sys_project_matrix_nonZero, host_sys_project_matrix_nonZero.data(), sizeof(int) * host_sys_project_matrix_nonZero.size(), cudaMemcpyHostToDevice);
		cudaMalloc((void**)&dev_sys_project_matrix_t_nonZero, sizeof(int) * host_sys_project_matrix_t_nonZero.size());
		cudaMemcpy(dev_sys_project_matrix_t_nonZero, host_sys_project_matrix_t_nonZero.data(), sizeof(int) * host_sys_project_matrix_t_nonZero.size(), cudaMemcpyHostToDevice);
		for (uint32_t i = 0; i < host_objectives_num; i++)
		{
			cudaMalloc((void**)&(dev_dnInfo[i]), sizeof(uint32_t));

			mMatrixX sys_x = host_sys_x[i];
			cudaMalloc((void**)&(dev_sys_x[i]), sizeof(qeal) * sys_x.size());
			cudaMemcpy(dev_sys_x[i], sys_x.data(), sizeof(qeal) * sys_x.size(), cudaMemcpyHostToDevice);

			mMatrixX sys_y = host_sys_y[i];
			cudaMalloc((void**)&(dev_sys_y[i]), sizeof(qeal) * sys_y.size());
			cudaMemcpy(dev_sys_y[i], sys_y.data(), sizeof(qeal) * sys_y.size(), cudaMemcpyHostToDevice);

			mMatrixX sys_z = host_sys_z[i];
			cudaMalloc((void**)&(dev_sys_z[i]), sizeof(qeal) * sys_z.size());
			cudaMemcpy(dev_sys_z[i], sys_z.data(), sizeof(qeal) * sys_z.size(), cudaMemcpyHostToDevice);

			cudaMalloc((void**)&(dev_sub_x[i]), sizeof(qeal) * (host_reduce_dim[i] / 3));
			cudaMalloc((void**)&(dev_sub_y[i]), sizeof(qeal) * (host_reduce_dim[i] / 3));
			cudaMalloc((void**)&(dev_sub_z[i]), sizeof(qeal) * (host_reduce_dim[i] / 3));

			cudaMalloc((void**)&(dev_sys_project_matrix_csrRowPtr[i]), sizeof(int) * host_sys_project_matrix_csrRowPtr[i].size());
			cudaMemcpy(dev_sys_project_matrix_csrRowPtr[i], host_sys_project_matrix_csrRowPtr[i].data(), sizeof(int) * host_sys_project_matrix_csrRowPtr[i].size(), cudaMemcpyHostToDevice);

			cudaMalloc((void**)&(dev_sys_project_matrix_csrColInd[i]), sizeof(int) * host_sys_project_matrix_csrColInd[i].size());
			cudaMemcpy(dev_sys_project_matrix_csrColInd[i], host_sys_project_matrix_csrColInd[i].data(), sizeof(int) * host_sys_project_matrix_csrColInd[i].size(), cudaMemcpyHostToDevice);

			cudaMalloc((void**)&(dev_sys_project_matrix_csrVal[i]), sizeof(qeal) * host_sys_project_matrix_csrVal[i].size());
			cudaMemcpy(dev_sys_project_matrix_csrVal[i], host_sys_project_matrix_csrVal[i].data(), sizeof(qeal) * host_sys_project_matrix_csrVal[i].size(), cudaMemcpyHostToDevice);

			cudaMalloc((void**)&(dev_sys_project_matrix_t_csrRowPtr[i]), sizeof(int) * host_sys_project_matrix_t_csrRowPtr[i].size());
			cudaMemcpy(dev_sys_project_matrix_t_csrRowPtr[i], host_sys_project_matrix_t_csrRowPtr[i].data(), sizeof(int) * host_sys_project_matrix_t_csrRowPtr[i].size(), cudaMemcpyHostToDevice);

			cudaMalloc((void**)&(dev_sys_project_matrix_t_csrColInd[i]), sizeof(int) * host_sys_project_matrix_t_csrColInd[i].size());
			cudaMemcpy(dev_sys_project_matrix_t_csrColInd[i], host_sys_project_matrix_t_csrColInd[i].data(), sizeof(int) * host_sys_project_matrix_t_csrColInd[i].size(), cudaMemcpyHostToDevice);

			cudaMalloc((void**)&(dev_sys_project_matrix_t_csrVal[i]), sizeof(qeal) * host_sys_project_matrix_t_csrVal[i].size());
			cudaMemcpy(dev_sys_project_matrix_t_csrVal[i], host_sys_project_matrix_t_csrVal[i].data(), sizeof(qeal) * host_sys_project_matrix_t_csrVal[i].size(), cudaMemcpyHostToDevice);
		}
		...
		if (host_total_sys_project_matrix_csrRowPtr.size() == 0)
		{
			Eigen::SparseMatrix<qeal> host_total_sys_project_matrix(host_total_fullspace_dim, host_total_reduce_dim);
			host_total_sys_project_matrix.setFromTriplets(host_total_sys_project_matrix_triplet.begin(), host_total_sys_project_matrix_triplet.end());
			Eigen::SparseMatrix<qeal> host_total_sys_project_matrix_t = host_total_sys_project_matrix.transpose();
			convertSparseMatrixToCSR(host_total_sys_project_matrix, host_total_sys_project_matrix_csrRowPtr, host_total_sys_project_matrix_csrColInd, host_total_sys_project_matrix_csrVal, host_total_sys_project_matrix_nonZero);
			convertSparseMatrixToCSR(host_total_sys_project_matrix_t, host_total_sys_project_matrix_t_csrRowPtr, host_total_sys_project_matrix_t_csrColInd, host_total_sys_project_matrix_t_csrVal, host_total_sys_project_matrix_t_nonZero);
		}

		cudaMalloc((void**)&dev_total_sys_project_matrix_csrRowPtr, sizeof(int) * host_total_sys_project_matrix_csrRowPtr.size());
		cudaMemcpy(dev_total_sys_project_matrix_csrRowPtr, host_total_sys_project_matrix_csrRowPtr.data(), sizeof(int) * host_total_sys_project_matrix_csrRowPtr.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_total_sys_project_matrix_csrColInd, sizeof(int) * host_total_sys_project_matrix_csrColInd.size());
		cudaMemcpy(dev_total_sys_project_matrix_csrColInd, host_total_sys_project_matrix_csrColInd.data(), sizeof(int) * host_total_sys_project_matrix_csrColInd.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_total_sys_project_matrix_csrVal, sizeof(qeal) * host_total_sys_project_matrix_csrVal.size());
		cudaMemcpy(dev_total_sys_project_matrix_csrVal, host_total_sys_project_matrix_csrVal.data(), sizeof(qeal) * host_total_sys_project_matrix_csrVal.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_total_sys_project_matrix_nonZero, sizeof(int));
		cudaMemcpy(dev_total_sys_project_matrix_nonZero, &host_total_sys_project_matrix_nonZero, sizeof(int), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_total_sys_project_matrix_t_csrRowPtr, sizeof(int) * host_total_sys_project_matrix_t_csrRowPtr.size());
		cudaMemcpy(dev_total_sys_project_matrix_t_csrRowPtr, host_total_sys_project_matrix_t_csrRowPtr.data(), sizeof(int) * host_total_sys_project_matrix_t_csrRowPtr.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_total_sys_project_matrix_t_csrColInd, sizeof(int) * host_total_sys_project_matrix_t_csrColInd.size());
		cudaMemcpy(dev_total_sys_project_matrix_t_csrColInd, host_total_sys_project_matrix_t_csrColInd.data(), sizeof(int) * host_total_sys_project_matrix_t_csrColInd.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_total_sys_project_matrix_t_csrVal, sizeof(qeal) * host_total_sys_project_matrix_t_csrVal.size());
		cudaMemcpy(dev_total_sys_project_matrix_t_csrVal, host_total_sys_project_matrix_t_csrVal.data(), sizeof(qeal) * host_total_sys_project_matrix_t_csrVal.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_total_sys_project_matrix_t_nonZero, sizeof(int));
		cudaMemcpy(dev_total_sys_project_matrix_t_nonZero, &host_total_sys_project_matrix_t_nonZero, sizeof(int), cudaMemcpyHostToDevice);
		...
		cudaMalloc((void**)&dev_object_obj_pairs_num, sizeof(uint32_t));
		cudaMemcpy(dev_object_obj_pairs_num, &host_object_obj_pairs_num, sizeof(uint32_t), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_m_primitives_pairs_list, sizeof(uint32_t)* host_m_primitives_pairs_list.size());
		...
		cudaMalloc((void**)&dev_m_primitives_pairs_offset, sizeof(uint32_t)* host_m_primitives_pairs_offset.size());
		...
		cudaMalloc((void**)&dev_m_primitives_pairs_num, sizeof(uint32_t)* host_m_primitives_pairs_num.size());
		...
		cudaMalloc((void**)&dev_sc_primitives_pair_list, sizeof(uint32_t)* host_sc_primitives_pair_list.size());
		...
		cudaMalloc((void**)&dev_sc_primitives_pair_offset, sizeof(uint32_t)* host_sc_primitives_pair_offset.size());
		...
		cudaMalloc((void**)&dev_sc_primitives_pair_num, sizeof(uint32_t)* host_sc_primitives_pair_num.size());
		...
		cudaMalloc((void**)&dev_detect_primitives_num, sizeof(uint32_t));

		cudaMalloc((void**)&dev_detect_primitives_list, (host_total_sc_primitive_pair_num + host_total_m_primitive_pair_num) * 2 * sizeof(uint32_t));
		/////
		cudaMalloc((void**)&dev_cell_size, sizeof(qeal) * host_cell_size.size());
		cudaMemcpy(dev_cell_size, host_cell_size.data(), sizeof(qeal) * host_cell_size.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_cell_grid, sizeof(qeal) * host_cell_grid.size());
		cudaMemcpy(dev_cell_grid, host_cell_grid.data(), sizeof(qeal) * host_cell_grid.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_grid_size, sizeof(uint32_t) * host_grid_size.size());
		cudaMemcpy(dev_grid_size, host_grid_size.data(), sizeof(uint32_t) * host_grid_size.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_colliding_cell_num, sizeof(uint32_t));
		...
		cudaMalloc((void**)&dev_detect_faces_cell_pair_num, sizeof(uint32_t));
		...
		cudaMalloc((void**)&dev_detect_faces_pair_num, sizeof(uint32_t));

		dev_surface_point_collide_floor_flag = host_surface_point_collide_floor_flag;

		host_floor_damping = 20.0;
		cudaMalloc((void**)&dev_floor_damping, sizeof(qeal));
		cudaMemcpy(dev_floor_damping, &host_floor_damping, sizeof(qeal), cudaMemcpyHostToDevice);

		///////////////////////////////////
		cudaMalloc((void**)&dev_total_branch_num, sizeof(uint32_t));
		cudaMemcpy(dev_total_branch_num, &host_total_branch_num, sizeof(uint32_t), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_branch_num, sizeof(uint32_t) * host_branch_num.size());
		cudaMemcpy(dev_branch_num, host_branch_num.data(), sizeof(uint32_t) * host_branch_num.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_branch_offset, sizeof(uint32_t) * host_branch_offset.size());
		cudaMemcpy(dev_branch_offset, host_branch_offset.data(), sizeof(uint32_t) * host_branch_offset.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_total_surface_faces_self_collision_culling_flag, sizeof(uint32_t) * host_total_surface_faces_self_collision_culling_flag.size());
		cudaMemcpy(dev_total_surface_faces_self_collision_culling_flag, host_total_surface_faces_self_collision_culling_flag.data(), sizeof(uint32_t) * host_total_surface_faces_self_collision_culling_flag.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_total_surface_points_self_collision_culling_flag, sizeof(uint32_t) * host_total_surface_points_self_collision_culling_flag.size());
		cudaMemcpy(dev_total_surface_points_self_collision_culling_flag, host_total_surface_points_self_collision_culling_flag.data(), sizeof(uint32_t) * host_total_surface_points_self_collision_culling_flag.size(), cudaMemcpyHostToDevice);

		cudaMalloc((void**)&dev_total_surface_faces_ref_branch_list, sizeof(uint32_t) * host_total_surface_faces_ref_branch_list.size());
		cudaMemcpy(dev_total_surface_faces_ref_branch_list, host_total_surface_faces_ref_branch_list.data(), sizeof(uint32_t) * host_total_surface_faces_ref_branch_list.size(), cudaMemcpyHostToDevice);
		...
		cudaMalloc((void**)&dev_detect_faces_list, sizeof(uint32_t) * host_detect_faces_list.size());
	...
	void PufferBallSimulator::freeCudaBuffer()
	{
		...
		cudaFree(dev_surface_point_collision_floor_stiffness);
		cudaFree(dev_surface_sphere_point_collision_floor_stiffness);
		...
		cudaFree(dev_enlarge_primitives_for_show);
		...
		cudaFree(dev_tet_volume_constraint_weight);
		cudaFree(dev_tet_DrMatirx_inv);
		cudaFree(dev_tet_R_matrix);
		cudaFree(dev_total_tet_volume_constraint_tet_num);
		cudaFree(dev_tet_volume_constraint_tet_list);
		...
		for (uint32_t i = 0; i < dev_each_sphere_gravity_force.size(); i++)
			cudaFree(dev_each_sphere_gravity_force[i]);

		for (uint32_t i = 0; i < dev_each_sphere_init_velocity.size(); i++)
			cudaFree(dev_each_sphere_init_velocity[i]);
		
		cudaFree(dev_surface_points_force);
		cudaFree(dev_surface_points_floor_collision_force);
		...
		for (uint32_t i = 0; i < dev_sys_project_matrix_csrRowPtr.size(); i++)
		{
			cudaFree(dev_sys_project_matrix_csrRowPtr[i]);
			cudaFree(dev_sys_project_matrix_t_csrRowPtr[i]);
		}

		for (uint32_t i = 0; i < dev_sys_project_matrix_csrColInd.size(); i++)
		{
			cudaFree(dev_sys_project_matrix_csrColInd[i]);
			cudaFree(dev_sys_project_matrix_t_csrColInd[i]);
		}

		for (uint32_t i = 0; i < dev_sys_project_matrix_csrVal.size(); i++)
		{
			cudaFree(dev_sys_project_matrix_csrVal[i]);
			cudaFree(dev_sys_project_matrix_t_csrVal[i]);
		}

		cudaFree(dev_total_sys_project_matrix_csrRowPtr);
		cudaFree(dev_total_sys_project_matrix_csrColInd);
		cudaFree(dev_total_sys_project_matrix_csrVal);
		cudaFree(dev_total_sys_project_matrix_nonZero);

		cudaFree(dev_total_sys_project_matrix_t_csrRowPtr);
		cudaFree(dev_total_sys_project_matrix_t_csrColInd);
		cudaFree(dev_total_sys_project_matrix_t_csrVal);
		cudaFree(dev_total_sys_project_matrix_t_nonZero);

		cudaFree(dev_sys_project_matrix_nonZero);
		cudaFree(dev_sys_project_matrix_t_nonZero);
		...
		/////////////////////
		cudaFree(dev_total_branch_num);
		cudaFree(dev_branch_num);
		cudaFree(dev_branch_offset);
		cudaFree(dev_total_surface_faces_self_collision_culling_flag);
		cudaFree(dev_total_surface_points_self_collision_culling_flag);
		cudaFree(dev_total_surface_faces_ref_branch_list);

		cudaFree(dev_floor_damping);
		//
	...
	void PufferBallSimulator::run()
	{
		...
		for (uint32_t i = 0; i < host_each_sphere_has_shot.size(); i++)
		{
			if (!host_each_sphere_has_shot[i])
				cudaMemcpy(dev_tet_nodes_position + host_fullspace_dim_buffer_offset[i], dev_rest_tet_nodes_position + host_fullspace_dim_buffer_offset[i], sizeof(qeal) * host_fullspace_dim[i] , cudaMemcpyDeviceToDevice);
		}
	...
	void PufferBallSimulator::oneIteration()
	{
		...
		cusparseDcsrmv(cusparseH, CUSPARSE_OPERATION_NON_TRANSPOSE,
			host_total_reduce_dim, host_total_fullspace_dim,
			host_total_sys_project_matrix_t_nonZero,
			&cublas_pos_one, spdescrA,
			dev_total_sys_project_matrix_t_csrVal,
			dev_total_sys_project_matrix_t_csrRowPtr,
			dev_total_sys_project_matrix_t_csrColInd,
			dev_project_nodes_position,
			&cublas_zero,
...
#else
		cusparseScsrmv(cusparseH, CUSPARSE_OPERATION_NON_TRANSPOSE,
			host_total_reduce_dim, host_total_fullspace_dim,
			host_total_sys_project_matrix_t_nonZero,
			&cublas_pos_one, spdescrA,
			dev_total_sys_project_matrix_t_csrVal,
		...
		for (uint32_t i = 0; i < host_objectives_num; i++)
		{	
			convertSubVectorHost
			(
				host_reduce_dim[i],
				dev_reduce_dim + i,
				dev_reduce_dim_buffer_offset + i,
				dev_reduce_displacement,
				dev_sub_x[i],
				dev_sub_y[i],
				dev_sub_z[i]
			...
			cudaDeviceSynchronize();
#else
			cusolverDnSpotrs(dnHandle, dnUplo, host_reduce_dim[i] / 3, 1, dev_sys_x[i], host_reduce_dim[i] / 3, dev_sub_x[i], host_reduce_dim[i] / 3, dev_dnInfo[i]);
			cudaDeviceSynchronize();
			cusolverDnSpotrs(dnHandle, dnUplo, host_reduce_dim[i] / 3, 1, dev_sys_y[i], host_reduce_dim[i] / 3, dev_sub_y[i], host_reduce_dim[i] / 3, dev_dnInfo[i]);
			cudaDeviceSynchronize();
			cusolverDnSpotrs(dnHandle, dnUplo, host_reduce_dim[i] / 3, 1, dev_sys_z[i], host_reduce_dim[i] / 3, dev_sub_z[i], host_reduce_dim[i] / 3, dev_dnInfo[i]);
			cudaDeviceSynchronize();
#endif
			convertFullVectorHost
			(
				host_reduce_dim[i],
				dev_reduce_dim + i,
				dev_reduce_dim_buffer_offset + i,
...
#ifdef USE_DOUBLE_PRECISION
		cusparseDcsrmv(cusparseH, CUSPARSE_OPERATION_NON_TRANSPOSE,
			host_total_fullspace_dim, host_total_reduce_dim,
			host_total_sys_project_matrix_nonZero,
			&cublas_pos_one, spdescrA,
			dev_total_sys_project_matrix_csrVal,
			dev_total_sys_project_matrix_csrRowPtr,
			dev_total_sys_project_matrix_csrColInd,
			dev_reduce_displacement,
			&cublas_zero,
			dev_fullspace_displacement
		);
		cudaDeviceSynchronize();
#else
		cusparseScsrmv(cusparseH, CUSPARSE_OPERATION_NON_TRANSPOSE,
	...
	void PufferBallSimulator::calculateExternalForce()
	{
		for (int i = 0; i < host_objectives_num; i++)
		{
			if(host_each_sphere_has_shot[i])
				cudaMemcpy(dev_tet_nodes_force + host_fullspace_dim_buffer_offset[i], dev_each_sphere_gravity_force[i], sizeof(qeal) * host_fullspace_dim[i], cudaMemcpyDeviceToDevice);
		}
		...
		mapSurfaceForceToTetMeshForPufferBallHost
	...
	void PufferBallSimulator::calculateFirstItemRight()
	{
#ifdef USE_DOUBLE_PRECISION 
...
#endif
		cudaMemcpy(dev_Ms_n, dev_ori_b, host_total_fullspace_dim * sizeof(qeal), cudaMemcpyDeviceToDevice);
	...
	void PufferBallSimulator::calculateVelocity()
	{
	...
	void PufferBallSimulator::postRun()
	{
		cudaMemcpy(host_tet_nodes_position.data(), dev_tet_nodes_position, sizeof(qeal) * host_total_fullspace_dim, cudaMemcpyDeviceToHost);
		updateSurface();
		updateMedialMesh();
	...
	void PufferBallSimulator::collision()
	{
		collideWithFloorForPufferBallHost // collide with box and floor
		(
	...
	void PufferBallSimulator::updateSurface()
	{
		updateSurfaceHost
		(
			host_total_surface_points_num,
	...
	void PufferBallSimulator::computeSurfaceBbox()
	{
	...
	void PufferBallSimulator::updateMedialMesh()
	{
	...
	void PufferBallSimulator::generateCollisionInfo()
	{
		...
		if (host_total_m_primitive_pair_num == 0 || host_total_sc_primitive_pair_num == 0)
		{
			...
			for (uint32_t obj_id = 0; obj_id < host_objectives_num; obj_id++)
			{
				...
				//cc
				for (uint32_t i = 0; i < cone_num - 6; i++)
				{
					...
					for (uint32_t j = i + 1; j < cone_num - 6; j++)
					{
		...
		host_detect_faces_cell_pair_list.resize(host_total_surface_faces_num);
		...
		//	
		for (uint32_t i = 0; i < host_total_surface_faces_self_collision_culling_flag.size(); i++)
		{
			if (host_total_surface_faces_self_collision_culling_flag[i] == 0)
				host_detect_faces_list.push_back(i);
		}
		host_total_detect_faces_num = host_total_surface_faces_self_collision_culling_flag.size();

	}

	void PufferBallSimulator::computeSceneVoxelGrid()
	{
		...
		host_cell_size[0] = max_length;
		host_cell_size[1] = max_length;
		host_cell_size[2] = max_length;
	...
	void PufferBallSimulator::initBoundingInfo()
	{
		...
		for (uint32_t i = 0; i < host_total_surface_points_num; i++)
		{
			...
			if (pid < cone_num)
				pid = cone_offset + pid;
			else if (pid < (cone_num + slab_num))
				pid = host_total_medial_cones_num + slab_offset + (pid - cone_num);
			else pid = host_total_medial_cones_num + host_total_medial_slabs_num;
	...
	void PufferBallSimulator::addMeshConfig(PufferBallConfig * mc)
	{
		...
		host_surface_sphere_point_collision_floor_stiffness.resize(host_total_surface_points_num);
		for (uint32_t i = surface_points_offset; i < host_total_surface_points_num; i++)
		{
			...
			host_surface_sphere_point_collision_floor_stiffness[i] = mc->fc_sphere_stiffness;
		}
		...
		for (uint32_t i = 0; i < mc->tet_tvw.size(); i++)
			host_tet_volume_constraint_weight.push_back(mc->tet_tvw[i]);
		...
		for (uint32_t i = 0; i < mc->tet_volume_constraint_tet_list.size(); i++)
		{
			host_tet_volume_constraint_tet_list.push_back(tet_elements_offset + mc->tet_volume_constraint_tet_list[i]);
		}
		host_total_tet_volume_constraint_tet_num = host_tet_volume_constraint_tet_list.size();
		...
		host_tet_nodes_velocity.resize(3 * host_total_tet_nodes_num, 0);
		std::vector<qeal> sphere_velocity;
		for (uint32_t i = 0; i < mc->tet_nodes_num; i++)
		{
			sphere_velocity.push_back(mc->init_velocity[0]);
			sphere_velocity.push_back(mc->init_velocity[1]);
			sphere_velocity.push_back(mc->init_velocity[2]);
		}
		host_each_sphere_init_velocity.push_back(sphere_velocity);

		host_tet_nodes_gravity_force.resize(3 * host_total_tet_nodes_num);
		//
		std::vector<qeal> sphere_gravity;
		for (uint32_t i = 0; i < mc->node_gravity.size(); i++)
		{
			host_tet_nodes_gravity_force[3 * tet_nodes_offset + i] = mc->node_gravity[i];
			sphere_gravity.push_back(mc->node_gravity[i]);
		}
		host_each_sphere_gravity_force.push_back(sphere_gravity);
		...
		host_sys_project_matrix_csrRowPtr.push_back(mc->sys_project_matrix_csrRowPtr);
		host_sys_project_matrix_csrColInd.push_back(mc->sys_project_matrix_csrColInd);
		std::vector<qeal> sys_project_matrix_csrVal(mc->sys_project_matrix_csrVal.size());
		for (uint32_t i = 0; i < mc->sys_project_matrix_csrVal.size(); i++)
			sys_project_matrix_csrVal.push_back(mc->sys_project_matrix_csrVal[i]);
		host_sys_project_matrix_csrVal.push_back(sys_project_matrix_csrVal);
		host_sys_project_matrix_nonZero.push_back(mc->sys_project_matrix_nonZero);

		host_sys_project_matrix_t_csrRowPtr.push_back(mc->sys_project_matrix_t_csrRowPtr);
		host_sys_project_matrix_t_csrColInd.push_back(mc->sys_project_matrix_t_csrColInd);
		std::vector<qeal> sys_project_matrix_t_csrVal(mc->sys_project_matrix_t_csrVal.size());
		for (uint32_t i = 0; i < mc->sys_project_matrix_t_csrVal.size(); i++)
			sys_project_matrix_t_csrVal.push_back(mc->sys_project_matrix_t_csrVal[i]);
		host_sys_project_matrix_t_csrVal.push_back(sys_project_matrix_t_csrVal);
		host_sys_project_matrix_t_nonZero.push_back(mc->sys_project_matrix_t_nonZero);

		for (uint32_t i = 0; i < mc->sys_project_matrix_triplet.size(); i++)
		{
			int row = mc->sys_project_matrix_triplet[i].row() + fullspace_dim_offset;
			int col = mc->sys_project_matrix_triplet[i].col() + reduce_dim_offset;
			qeal value = mc->sys_project_matrix_triplet[i].value();

			host_total_sys_project_matrix_triplet.push_back(Eigen::Triplet<qeal>(row, col, value));
		}

		///////////////////////////////
		host_branch_num.push_back(host_objectives_num);
		uint32_t branch_offset = host_total_branch_num;
		host_branch_offset.push_back(branch_offset);
		host_total_branch_num += mc->branch_num;
		for (uint32_t i = 0; i < mc->surface_faces_self_collision_culling_flag.size(); i++)
			host_total_surface_faces_self_collision_culling_flag.push_back(mc->surface_faces_self_collision_culling_flag[i]);

		for (uint32_t i = 0; i < mc->surface_points_self_collision_culling_flag.size(); i++)
			host_total_surface_points_self_collision_culling_flag.push_back(mc->surface_points_self_collision_culling_flag[i]);

		for (uint32_t i = 0; i < mc->surface_faces_ref_branch_list.size(); i++)
			host_total_surface_faces_ref_branch_list.push_back(branch_offset + mc->surface_faces_ref_branch_list[i]);
	}

	void PufferBallSimulator::shootSphere()
	{
		host_shoot_shpere += 1;
		if (host_shoot_shpere > host_objectives_num)
			host_shoot_shpere = host_objectives_num;
		if (host_shoot_shpere >= host_objectives_num)
			return;

		if (host_each_sphere_has_shot[host_shoot_shpere])
			return;
		host_each_sphere_has_shot[host_shoot_shpere] = true;

		cudaMemcpy(dev_tet_nodes_velocity + host_fullspace_dim_buffer_offset[host_shoot_shpere], dev_each_sphere_init_velocity[host_shoot_shpere], sizeof(qeal) * host_fullspace_dim[host_shoot_shpere], cudaMemcpyDeviceToDevice);

	}

	mVector3 PufferBallSimulator::getTetNodePosition(const uint32_t vid)
	{
		return mVector3(host_tet_nodes_position[3 * vid], host_tet_nodes_position[3 * vid + 1], host_tet_nodes_position[3 * vid + 2]);
	}

	mVector4i PufferBallSimulator::getTetElementNodeIndex(const uint32_t eid)
	{
	...
	mVector3 PufferBallSimulator::getSurfacePointPosition(const uint32_t vid)
	{
	...
	mVector3i PufferBallSimulator::getSurfaceFaceIndex(const uint32_t fid)
	{
		return mVector3i(host_surface_faces_index[3 * fid], host_surface_faces_index[3 * fid + 1], host_surface_faces_index[3 * fid + 2]);
	}

	inline mVector4 PufferBallSimulator::getMedialNodePosition(const uint32_t vid)
	{
	...
	void PufferBallSimulator::readDrawBoxFromObjFile(const std::string filename)
	{
		...
		draw_box_points_num = attrib.vertices.size() / 3;
		draw_box_points_position.resize(attrib.vertices.size());
		for (uint32_t i = 0; i < attrib.vertices.size(); i++)
			draw_box_points_position[i] = attrib.vertices[i];
		draw_box_faces_num = 0;
		uint32_t group_num = shapes.size();
		for (uint32_t i = 0; i < group_num; i++)
		{
			uint32_t group_faces_num = shapes[i].mesh.indices.size() / 3;
			draw_box_faces_num += group_faces_num;
			for (size_t f = 0; f < group_faces_num; f++)
			{
				...
				draw_box_faces_index.push_back(vid0);
				draw_box_faces_index.push_back(vid1);
				draw_box_faces_index.push_back(vid2);
			}
		}
		fin.close();
		draw_box_color = mVector3(0.9, 0.9, 0.9);

		return;
	}

	bool PufferBallConfig::loadSceneObjectiveConfig(const std::string path, TiXmlElement* item, const double timeStep)
	{
		time_step = timeStep;
		...
		while (child_item)
		{
			...
			if (item_name == std::string("color"))
			{
				...
				double x, y, z;
				ss >> x >> y >> z;
				surface_color = Eigen::Vector3d(x / 255.0, y / 255.0, z / 255.0);
			}
			...
			else if (item_name == std::string("sphere_density"))
			{
				std::string density_str = child_item->GetText();
				ss << density_str;
				double v;
			...
			else if (item_name == std::string("volumeConstraint"))
			{
				TiXmlAttribute* sc_attri = child_item->FirstAttribute();
				while (sc_attri)
				{
					...
					if (attri_name == std::string("weight"))
					{
						tvw = sc_attri->DoubleValue();
					}
					sc_attri = sc_attri->Next();
				}
			}
			else if (item_name == std::string("sphereConstraint"))
			{
				TiXmlAttribute* sc_attri = child_item->FirstAttribute();
				while (sc_attri)
				{
					...
					if (attri_name == std::string("weight"))
					{
						sphere_tsw = sc_attri->DoubleValue();
					}
					sc_attri = sc_attri->Next();
				}
			}
			else if (item_name == std::string("init_velocity"))
			{
				...
				uint32_t max_times;
				ss >> x >> y >> z;
				init_velocity = Eigen::Vector3d(x, y, z);
			}
	...
	bool PufferBallConfig::loadMesh(const std::string path, const std::string name)
	{
		return  loadSurfaceMesh(path, name) && loadTetMesh(path, name) && loadMedialMesh(path, name);
	}

	bool PufferBallConfig::loadSurfaceMesh(const std::string path, const std::string name)
	{
	...
	bool PufferBallConfig::loadTetMesh(const std::string path, const std::string name)
	{
	...
	bool PufferBallConfig::loadMedialMesh(const std::string path, const std::string name)
	{
	...
	int PufferBallConfig::searchCloseTetNode(Eigen::Vector3d p)
	{
	...
	void PufferBallConfig::computeSurfaceTetInterpolation()
	{
	...
	void PufferBallConfig::computeMaTetInterpolation()
	{
		...
		for (uint32_t i = 0; i < ma_nodes_num; i++)
		{
			...
			//	system("pause");
				...
				for (uint32_t j = 0; j < tet_elements_num; j++)
				{
					...
					for (uint32_t k = 0; k < 4; k++)
					{
						uint32_t nid = tet_elements[4 * j + k];
						cent += getTetNodePosition(nid);
					}
					cent /= 4.0;
					double dist = (p - cent).norm();
				...
				Eigen::Vector4d w;
				isinsideTetElement(coordinate.first, p, w);
				coordinate.second = w;
			}
	...
	bool PufferBallConfig::isinsideTetElement(const uint32_t eid, const Eigen::Vector3d p, Eigen::Vector4d & weight)
	{
	...
	void PufferBallConfig::computeBarycentricWeights(const uint32_t eid, const Eigen::Vector3d p, Eigen::Vector4d & weight)
	{
	...
	Eigen::Matrix4d PufferBallConfig::computeTetElementInvShapeFunction(const uint32_t eid)
	{
		uint32_t tet[4];
	...
	void PufferBallConfig::initlialization()
	{
		setFramesAndFixed();
		readBranchInfo();
	...
	void PufferBallConfig::setFramesAndFixed()
	{
	...
	void PufferBallConfig::readBranchInfo()
	{
		std::string filename_path = obj_path + "/tet_branch/";
		std::string config_filename = filename_path + "config.txt";
		...
		branch_ref_tet_nodes_list.resize(branch_num);
		branch_ref_tet_elements_list.resize(branch_num);
		tet_element_ref_branch_list.resize(tet_elements_num);
		for (uint32_t i = 0; i < branch_num; i++)
		{
			QString index_str;
			index_str.setNum(i);
			std::string branch_filename = filename_path + "tet_parts_" + index_str .toStdString()+ ".txt";
			fin.open(branch_filename.c_str());
			if (fin.is_open())
			{
				uint32_t ref_tet_num;
				fin >> ref_tet_num;
				branch_ref_tet_elements_list[i].resize(ref_tet_num);
				std::unordered_set<uint32_t> ref_nodes;
				for (uint32_t j = 0; j < ref_tet_num; j++)
				{
					uint32_t ref_eid;
					fin >> ref_eid;
					branch_ref_tet_elements_list[i][j] = ref_eid;
					for (uint32_t k = 0; k < 4; k++)
					{
						uint32_t node_id = tet_elements[4 * ref_eid + k];
						ref_nodes.insert(node_id);
					}
					tet_element_ref_branch_list[ref_eid] = i;
				}
				std::unordered_set<uint32_t>::iterator it = ref_nodes.begin();
				for (; it != ref_nodes.end(); ++it)
					branch_ref_tet_nodes_list[i].push_back(*it);
				fin.close();
			}
		}

		tet_nodes_ref_branch_list.resize(tet_nodes_num);
		std::fill(tet_nodes_ref_branch_list.begin(), tet_nodes_ref_branch_list.end(), std::pair<int, int>(-1, -1));

		for (uint32_t branch_id = 0; branch_id < (branch_num - 1); branch_id++)
		{
			std::vector<uint32_t> ref_nodes = branch_ref_tet_nodes_list[branch_id];
			for (uint32_t i = 0; i < ref_nodes.size(); i++)
			{
				if (tet_nodes_ref_branch_list[ref_nodes[i]].first == -1)
				{
					tet_nodes_ref_branch_list[ref_nodes[i]].first = branch_id;
				}
			}
			branch_ref_tet_nodes_list[branch_id].clear();
		}

		uint32_t ball_branch_id = branch_num - 1;
		std::vector<uint32_t> node_indices_on_ball = branch_ref_tet_nodes_list[ball_branch_id];
		for (uint32_t i = 0; i < node_indices_on_ball.size(); i++)
		{
			if (tet_nodes_ref_branch_list[node_indices_on_ball[i]].first == -1)
				tet_nodes_ref_branch_list[node_indices_on_ball[i]].first = ball_branch_id;
		}
		branch_ref_tet_nodes_list[ball_branch_id].clear();

		for (uint32_t i = 0; i < tet_nodes_ref_branch_list.size(); i++)
		{
			branch_ref_tet_nodes_list[tet_nodes_ref_branch_list[i].first].push_back(i);
			tet_nodes_ref_branch_list[i].second = branch_ref_tet_nodes_list[tet_nodes_ref_branch_list[i].first].size() - 1;
		}

		tet_volume_constraint_tet_list = branch_ref_tet_elements_list[branch_num - 1];

		filename_path = obj_path + "/surface_branch/";
		config_filename = filename_path + "config.txt";

		fin.open(config_filename.c_str());
		if (fin.is_open())
		{
			uint32_t surface_branch_num;
			fin >> surface_branch_num;
			fin.close();
			if (surface_branch_num != branch_num)
			{
				std::cout << "Error: The files do not match !!!!" << std::endl;
				return;
			}
		}
		else return;

		surface_faces_self_collision_culling_flag.resize(surface_faces_num);
		surface_points_self_collision_culling_flag.resize(surface_points_num);
		std::fill(surface_faces_self_collision_culling_flag.begin(), surface_faces_self_collision_culling_flag.end(), 0);
		std::string free_selfcollide_filename = filename_path + "free_selfcollide.txt"; // culling self-intersection on model
		fin.open(free_selfcollide_filename.c_str());
		if (fin.is_open())
		{
			uint32_t culling_face_num;
			fin >> culling_face_num;
			for (uint32_t i = 0; i < culling_face_num; i++)
			{
				uint32_t face_id;
				fin >> face_id;
				surface_faces_self_collision_culling_flag[face_id] = 1;
				for (uint32_t k = 0; k < 3; k++)
				{
					uint32_t vid = surface_faces[3 * face_id + k];
					surface_points_self_collision_culling_flag[vid] = 1;
				}
			}
			fin.close();
		}

		branch_ref_surface_faces_list.resize(branch_num);
		branch_ref_surface_points_list.resize(branch_num);
		surface_faces_ref_branch_list.resize(surface_faces_num);
		for (int i = 0; i < branch_num; i++)
		{
			QString index_str;
			index_str.setNum(i);
			std::string branch_filename = filename_path + "branch_indices_" + index_str.toStdString() + ".txt";
			fin.open(branch_filename.c_str());
			if (fin.is_open())
			{
				uint32_t ref_faces_num, ref_points_num;
				fin >> ref_points_num >> ref_faces_num;
				std::unordered_set<uint32_t> ref_surface_points;
				for (uint32_t j = 0; j < ref_points_num; j++)
				{
					uint32_t vid;
					fin >> vid;
					ref_surface_points.insert(vid);
				}
				for (uint32_t j = 0; j < ref_faces_num; j++)
				{
					int face_id;
					fin >> face_id;
					branch_ref_surface_faces_list[i].push_back(face_id);
					surface_faces_ref_branch_list[face_id] = i;
				...
				std::unordered_set<uint32_t>::iterator it = ref_surface_points.begin();
				for (; it != ref_surface_points.end(); ++it)
					branch_ref_surface_points_list[i].push_back(*it);
			}
			fin.close();
		}

		//
		branch_ref_medial_cones_list.resize(branch_num);
		branch_ref_medial_slabs_list.resize(branch_num);
		branch_ref_frames_list.resize(branch_num);
		for (uint32_t i = 0; i < (branch_num - 1); i++)
		{
			for (uint32_t j = 0; j < 4; j++)
			{
				branch_ref_medial_cones_list[i].push_back(4 * i + j);
				branch_ref_frames_list[i].push_back(5 * i + 1 + j);
			}				
		}

		for (uint32_t j = 0; j < 7; j++)
			branch_ref_frames_list[branch_num - 1].push_back(5 * (branch_num - 1) + j);

		for (uint32_t j = 0; j < 6; j++)
			branch_ref_medial_cones_list[branch_num - 1].push_back(4 * (branch_num - 1) + j);
	}

	void PufferBallConfig::computeMassAndGravity()
	{
		...
		for (uint32_t i = 0; i < tet_nodes_num; i++)
		{
			...
			double tet_d;
			if (tet_nodes_ref_branch_list[i].first == branch_num - 1)
				tet_d = sphere_density;
			else tet_d = density;

			double mv = tet_d / (time_step * time_step);
			double inv_mv = (time_step * time_step) / tet_d;
	...
	void PufferBallConfig::computeLaplacianMatrix(std::vector<Eigen::Triplet<double>>& matValue)
	{
	...
	void PufferBallConfig::computeWeight(Eigen::MatrixXd & weight)
	{
		std::string tetWeightsFilename = obj_path + "tetWeights.dat";
		std::string surfaceWeightsFilename = obj_path + "surfaceWeights.dat";
		std::string mpWeightsFilename = obj_path + "mpWeights.dat";
		
		std::ifstream fin;
		fin.open(tetWeightsFilename.c_str(), std::ios::binary);
		if (fin.is_open())
		{
			EigenMatrixIO::read_binary(fin, weight);
			fin.close();
		}
		else
		{
			...
			for (int branch_id = 0; branch_id < branch_num; branch_id++)
				computeBranchWeight(weight, branch_id);

			std::ofstream fout(tetWeightsFilename.c_str(), std::ios::binary);
			EigenMatrixIO::write_binary(fout, weight);
			fout.close();
		}
		...
		fin.open(surfaceWeightsFilename.c_str(), std::ios::binary);
		if (fin.is_open())
		{
			EigenMatrixIO::read_binary(fin, surface_weight);
			fin.close();
		}
		else
		{
			...
			std::ofstream fout(surfaceWeightsFilename.c_str(), std::ios::binary);
			EigenMatrixIO::write_binary(fout, surface_weight);
			fout.close();
		}

		fin.open(mpWeightsFilename.c_str(), std::ios::binary);
		if (fin.is_open())
		{
			EigenMatrixIO::read_binary(fin, ma_weight);
			fin.close();
		}
		else
		{
			...
			std::ofstream fout(mpWeightsFilename.c_str(), std::ios::binary);
			EigenMatrixIO::write_binary(fout, ma_weight);
			fout.close();
		}
	}

	void PufferBallConfig::computeBranchWeight(Eigen::MatrixXd& weight, uint32_t branch_id)
	{
		std::vector<uint32_t> ref_tet_nodes_list = branch_ref_tet_nodes_list[branch_id];
		const uint32_t ref_tet_nodes_num = ref_tet_nodes_list.size();
		std::vector<uint32_t> ref_frames_list = branch_ref_frames_list[branch_id];
		const uint32_t ref_frames_num = ref_frames_list.size();

		int rowDim = ref_tet_nodes_num + ref_frames_num + ref_frames_num;
		int colDim = ref_tet_nodes_num + ref_frames_num;
		std::vector<Eigen::Triplet<double>> matValue;

		for (uint32_t i = 0; i < ref_tet_nodes_num; i++)
		{
			matValue.push_back(Eigen::Triplet<double>(i, i, 1));
			uint32_t vid = ref_tet_nodes_list[i];
			Eigen::Vector3d pos = getTetNodePosition(vid);
			double edgeLenTotal = 0.0;
			...
			{
				uint32_t nid = *it;
				if (tet_nodes_ref_branch_list[nid].first != branch_id)
					continue;
				Eigen::Vector3d np = getTetNodePosition(nid);
				double edgeLen = (pos - np).norm();
				edgeLenTotal += edgeLen;
			...
			for (auto it = neighbor.begin(); it != neighbor.end(); ++it)
			{
				...
				double edgeLen = (pos - np).norm();
				double wij = edgeLen / edgeLenTotal;
				matValue.push_back(Eigen::Triplet<double>(i, tet_nodes_ref_branch_list[nid].second, -wij));
			}
			uint32_t f = 0;
			for (auto it = link_ma.begin(); it != link_ma.end(); ++it)
			{
				...
				double edgeLen = (pos - neighbor_pos).norm();
				double wij = edgeLen / edgeLenTotal;
				matValue.push_back(Eigen::Triplet<double>(i, ref_tet_nodes_num + f, -wij));
			}
		}

		for (uint32_t f = 0; f < ref_frames_num; f++)
		{
			uint32_t mid = branch_ref_frames_list[branch_id][f];
			matValue.push_back(Eigen::Triplet<double>(ref_tet_nodes_num + f, ref_tet_nodes_num + f, 1));
			...
			for (uint32_t i = 0; i < 4; i++)
			{
				uint32_t vid = tet_elements[4 * ele_id + i];
				if (tet_nodes_ref_branch_list[vid].first != branch_id)
					continue;
				Eigen::Vector3d v = getTetNodePosition(vid);
				double norm = (pos - v).norm();
				edgeLenTotal += norm;
			}
			...
			for (uint32_t i = 0; i < 4; i++)
			{
				...
				Eigen::Vector3d v = getTetNodePosition(vid);
				double norm = (pos - v).norm();
				double wij = norm / edgeLenTotal;
				matValue.push_back(Eigen::Triplet<double>(ref_tet_nodes_num + f, tet_nodes_ref_branch_list[vid].second, -wij));
			}
		}

		uint32_t row_index = ref_tet_nodes_num + ref_frames_num;
		uint32_t col_index = ref_tet_nodes_num;

		for (int f = 0; f < ref_frames_num; f++)
		{
			matValue.push_back(Eigen::Triplet<double>(row_index + f, col_index + f, 1));
		}
		...
		for (int f = 0; f < ref_frames_num; f++)
		{
			Eigen::VectorXd d = transpose.col(ref_tet_nodes_num + ref_frames_num + f);
			Eigen::VectorXd result = LDLT.solve(d);
			Eigen::VectorXd cw = weight.col(4 * branch_id + f);
			cw.setZero();
			for (int i = 0; i < ref_tet_nodes_num; i++)
			{
				double w = result.data()[i];
				int nid = ref_tet_nodes_list[i];
				cw.data()[nid] = w;
			}

			Eigen::VectorXd fw(ref_frames_num);
			for (int fi = 0; fi < ref_frames_num; fi++)
			{
				double w = result.data()[ref_tet_nodes_num + f];
				cw.data()[tet_nodes_num + 4 * branch_id + fi] = w;
			}
			weight.col(4 * branch_id + f) = cw;
		}
	}

	void PufferBallConfig::computeHarmonicProjectMatrix(Eigen::SparseMatrix <double> & pm)
	{
		uint32_t tn = tet_nodes_num;
		...
		for (uint32_t i = 0; i < tn; i++)
		{
			...
			for (uint32_t j = 0; j < af; j++)
			{
				...
				uint32_t index = 0;
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i, 12 * j + index + 0, Ar.data()[0]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i, 12 * j + index + 3, Ar.data()[9]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i, 12 * j + index + 6, Ar.data()[18]));

				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 1, 12 * j + index + 1, Ar.data()[4]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 1, 12 * j + index + 4, Ar.data()[13]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 1, 12* j + index + 7, Ar.data()[22]));

				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 2, 12 * j + index + 2, Ar.data()[8]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 2, 12 * j + index + 5, Ar.data()[17]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 2, 12 * j + index + 8, Ar.data()[26]));
				index += 9;
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i, 12 *  j + index + 0, At.data()[0]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 1, 12 *  j + index + 1, At.data()[4]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 2, 12 * j + index + 2, At.data()[8]));
			}
		}
		...
		for (uint32_t i = 0; i < tn; i++)
		{
			...
			for (uint32_t j = 0; j < qf; j++)
			{
				...
				Qe.data()[26] = w * x02;
				uint32_t index = 0;
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i, 12 * af + 30 * j + index + 0, Qr.data()[0]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i, 12 * af + 30 * j + index + 3, Qr.data()[9]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i, 12 * af + 30 * j + index + 6, Qr.data()[18]));

				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 1, 12 * af + 30 * j + index + 1, Qr.data()[4]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 1, 12 * af + 30 * j + index + 4, Qr.data()[13]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 1, 12 * af + 30 * j + index + 7, Qr.data()[22]));

				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 2, 12 * af + 30 * j + index + 2, Qr.data()[8]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 2, 12 * af + 30 * j + index + 5, Qr.data()[17]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 2, 12 * af + 30 * j + index + 8, Qr.data()[26]));
				index += 9;
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i, 12 * af + 30 * j + index + 0, Qo.data()[0]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i, 12 * af + 30 * j + index + 3, Qo.data()[9]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i, 12 * af + 30 * j + index + 6, Qo.data()[18]));

				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 1, 12 * af + 30 * j + index + 1, Qo.data()[4]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 1, 12 * af + 30 * j + index + 4, Qo.data()[13]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 1, 12 * af + 30 * j + index + 7, Qo.data()[22]));

				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 2, 12 * af + 30 * j + index + 2, Qo.data()[8]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 2, 12 * af + 30 * j + index + 5, Qo.data()[17]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 2, 12 * af + 30 * j + index + 8, Qo.data()[26]));
				index += 9;
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i, 12 * af + 30 * j + index + 0, Qe.data()[0]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i, 12 * af + 30 * j + index + 3, Qe.data()[9]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i, 12 * af + 30 * j + index + 6, Qe.data()[18]));

				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 1, 12 * af + 30 * j + index + 1, Qe.data()[4]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 1, 12 * af + 30 * j + index + 4, Qe.data()[13]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 1, 12 * af + 30 * j + index + 7, Qe.data()[22]));

				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 2, 12 * af + 30 * j + index + 2, Qe.data()[8]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 2, 12 * af + 30 * j + index + 5, Qe.data()[17]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 2, 12 * af + 30 * j + index + 8, Qe.data()[26]));
				index += 9;
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i, 12 * af + 30 * j + index + 0, Qt.data()[0]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 1, 12 * af + 30 * j + index + 1, Qt.data()[4]));
				sys_project_matrix_triplet.push_back(Eigen::Triplet<double>(3 * i + 2, 12 * af + 30 * j + index + 2, Qt.data()[8]));
			}
		}
		pm.setFromTriplets(sys_project_matrix_triplet.begin(), sys_project_matrix_triplet.end());
	}

	void PufferBallConfig::setTetStrainConstraints(Eigen::SparseMatrix<double>& Ytet)
	{
		...
		for (uint32_t j = 0; j < tet_elements_num; j++)
		{
			...
			if (tet_element_ref_branch_list[j] == branch_num - 1)
				tet_tsw[j] = sphere_tsw;
	...
	void PufferBallConfig::setTetVolumeConstraints(Eigen::SparseMatrix<double>& Yvol)
	{
		uint32_t ref_tet_num = tet_volume_constraint_tet_list.size();
		
		tet_vc_DrMatrix_inv.resize(ref_tet_num);
		tet_vc_RMatrix_inv.resize(ref_tet_num);
		tet_vc_ATA.resize(ref_tet_num);
		tet_tvw.resize(ref_tet_num);
		for (uint32_t j = 0; j < ref_tet_num; j++)
		{
			uint32_t eid = tet_volume_constraint_tet_list[j];
			Eigen::Vector3d v[4];
			for (uint32_t k = 0; k < 4; k++)
			{
				uint32_t vid = tet_elements[4 * eid + k];
				v[k] = getTetNodePosition(vid);
			}
			Eigen::Vector3d lv1, lv2, lv3;
			lv1.data()[0] = v[0][0] - v[3][0];
			...
			tet_tvw[j] = tvw * m_w;
			Eigen::Matrix3d m_Dr_inv = m_Dr.inverse();
			tet_vc_DrMatrix_inv[j] = m_Dr_inv;
			Eigen::Matrix3d R;
			R.setIdentity();
			tet_vc_RMatrix_inv[j] = R;
		...
		////// set Ytet
		Yvol.resize(fullspace_dim, fullspace_dim);
		uint32_t tn = tet_nodes_num;
		uint32_t en = tet_elements_num;
		std::vector<std::set<uint32_t>> Yvol_map(tet_nodes_num);

		for (uint32_t i = 0; i < ref_tet_num; i++)
		{
			uint32_t eid = tet_volume_constraint_tet_list[i];
			uint32_t vid[4];
			for (uint32_t k = 0; k < 4; k++)
				vid[k] = tet_elements[4 * eid + k];

			Yvol_map[vid[0]].insert(vid[1]);
			Yvol_map[vid[0]].insert(vid[2]);
			Yvol_map[vid[0]].insert(vid[3]);

			Yvol_map[vid[1]].insert(vid[0]);
			Yvol_map[vid[1]].insert(vid[2]);
			Yvol_map[vid[1]].insert(vid[3]);

			Yvol_map[vid[2]].insert(vid[0]);
			Yvol_map[vid[2]].insert(vid[1]);
			Yvol_map[vid[2]].insert(vid[3]);

			Yvol_map[vid[3]].insert(vid[0]);
			Yvol_map[vid[3]].insert(vid[1]);
			Yvol_map[vid[3]].insert(vid[2]);
		}
		...
		for (uint32_t i = 0; i < tn; i++)
		{
			...
			for (auto it = Yvol_map[nid].begin(); it != Yvol_map[nid].end(); ++it)
			{
				uint32_t cid = *it;
				mat_Val.push_back(Eigen::Triplet<double>(3 * i, 3 * cid, 0));
				mat_Val.push_back(Eigen::Triplet<double>(3 * i + 1, 3 * cid + 1, 0));
		...
		Yvol.setFromTriplets(mat_Val.begin(), mat_Val.end());

		std::map<std::pair<uint32_t, uint32_t>, uint32_t> spMap;
		uint32_t flag = 0;
		for (uint32_t k = 0; k < Yvol.outerSize(); ++k)
			for (Eigen::SparseMatrix<double>::InnerIterator it(Yvol, k); it; ++it)
			{
				std::pair<uint32_t, uint32_t> index;
				index.first = it.row();
				index.second = it.col();
		...
		for (uint32_t ele = 0; ele < ref_tet_num; ele++)
		{
			uint32_t eid = tet_volume_constraint_tet_list[ele];
			Eigen::MatrixXd ATA = tet_vc_ATA[ele];
			double w = tet_tvw[ele];
			ATA *= w;
	...
	void PufferBallConfig::computeSysMatrix()
	{
		Eigen::SparseMatrix<double> Ytet;
		setTetStrainConstraints(Ytet);
		Eigen::SparseMatrix<double> Yvol;
		setTetVolumeConstraints(Yvol);
		Ytet += Yvol;
	...
	//	else
		{
			...
			Eigen::SparseMatrix<double> pmt = pm.transpose();

			convertSparseMatrixToCSRDouble(pm, sys_project_matrix_csrRowPtr, sys_project_matrix_csrColInd, sys_project_matrix_csrVal, sys_project_matrix_nonZero);
			convertSparseMatrixToCSRDouble(pmt, sys_project_matrix_t_csrRowPtr, sys_project_matrix_t_csrColInd, sys_project_matrix_t_csrVal, sys_project_matrix_t_nonZero);
			//
			Eigen::SparseMatrix<double> LHS = Ytet + mass;
			sys = pmt * LHS * pm;

			uint32_t sub_rows_size = sys.rows() / 3;
			uint32_t sub_cols_size = sys.cols() / 3;

			dof_Ax.resize(sub_rows_size, sub_cols_size);
			dof_Ax.setZero();
			dof_Ay.resize(sub_rows_size, sub_cols_size);
			dof_Ay.setZero();
			dof_Az.resize(sub_rows_size, sub_cols_size);
			dof_Az.setZero();

			for (int i = 0; i < sub_rows_size; i++)
			{
				for (int j = 0; j < sub_cols_size; j++)
				{
			...
			{
				double* dev_dx_sys;
				cudaMalloc((void**)&dev_dx_sys, sub_rows_size * sub_cols_size * sizeof(double));
				cudaMemcpy(dev_dx_sys, dof_Ax.data(), sub_rows_size * sub_cols_size * sizeof(double), cudaMemcpyHostToDevice);

				int bufferSize_dx = 0;
				cusolverDnDpotrf_bufferSize(dnHandle, dnUplo, sub_rows_size, dev_dx_sys, sub_cols_size, &bufferSize_dx);
				...
				cusolverStatus_t satus = cusolverDnDpotrf(dnHandle, dnUplo, sub_rows_size, dev_dx_sys, sub_cols_size, dev_buffer_dx, bufferSize_dx, dev_dxInfo);
			...
			{
				double* dev_dy_sys;
				cudaMalloc((void**)&dev_dy_sys, sub_rows_size * sub_cols_size * sizeof(double));
				cudaMemcpy(dev_dy_sys, dof_Ay.data(), sub_rows_size * sub_cols_size * sizeof(double), cudaMemcpyHostToDevice);

				int bufferSize_dy = 0;
				cusolverDnDpotrf_bufferSize(dnHandle, dnUplo, sub_rows_size, dev_dy_sys, sub_cols_size, &bufferSize_dy);
				...
				cusolverStatus_t satus = cusolverDnDpotrf(dnHandle, dnUplo, sub_rows_size, dev_dy_sys, sub_cols_size, dev_buffer_dy, bufferSize_dy, dev_dyInfo);
			...
			{
				double* dev_dz_sys;
				cudaMalloc((void**)&dev_dz_sys, sub_rows_size * sub_cols_size * sizeof(double));
				cudaMemcpy(dev_dz_sys, dof_Az.data(), sub_rows_size * sub_cols_size * sizeof(double), cudaMemcpyHostToDevice);

				int bufferSize_dz = 0;
				cusolverDnDpotrf_bufferSize(dnHandle, dnUplo, sub_rows_size, dev_dz_sys, sub_cols_size, &bufferSize_dz);
				...
				cusolverStatus_t satus = cusolverDnDpotrf(dnHandle, dnUplo, sub_rows_size, dev_dz_sys, sub_cols_size, dev_buffer_dz, bufferSize_dz, dev_dzInfo);
	...
	void PufferBallConfig::computeEncloseSpheres()
	{
	
		uint32_t total_primitive_num = ma_cones_num + ma_slabs_num;
		mp_enclose_surface_points_index.resize(total_primitive_num);
		mp_enclose_surface_points_interpolation.resize(total_primitive_num);
		surface_points_band_mp_index.resize(surface_points_num);
		surface_points_band_mp_interpolation.resize(3 * surface_points_num); 

		for (uint32_t branch_id = 0; branch_id < branch_num; branch_id++)
		{
			std::vector<uint32_t> ref_surface_points = branch_ref_surface_points_list[branch_id];
			std::vector<uint32_t> ref_medial_cones = branch_ref_medial_cones_list[branch_id];
			std::vector<uint32_t> ref_medial_slabs = branch_ref_medial_slabs_list[branch_id];

			for (uint32_t i = 0; i < ref_surface_points.size(); i++)
			{
				uint32_t point_id = ref_surface_points[i];
				...
				for (uint32_t j = 0; j < ref_medial_cones.size(); j++)
				{
					uint32_t cone_id = ref_medial_cones[j];
					uint32_t mid0 = ma_cones[2 * cone_id];
					uint32_t mid1 = ma_cones[2 * cone_id + 1];
				...
				for (uint32_t j = 0; j < ref_medial_slabs.size(); j++)
				{
					uint32_t slab_id = ref_medial_slabs[j];
					uint32_t mid0 = ma_slabs[3 * slab_id];
					uint32_t mid1 = ma_slabs[3 * slab_id + 1];
					uint32_t mid2 = ma_slabs[3 * slab_id + 2];
				...
				{
					surface_points_band_mp_interpolation[3 * point_id] = 0;
					surface_points_band_mp_interpolation[3 * point_id + 1] = 0;
					surface_points_band_mp_interpolation[3 * point_id + 2] = 0;
					surface_points_band_mp_index[point_id] = total_primitive_num;
					//std::cout << "enclose miss point !" << std::endl;
				}
				else if (min_cone_dist < min_slab_dist)
				{
					mp_enclose_surface_points_index[min_cone_id].push_back(point_id);
					...
					surface_points_band_mp_interpolation[3 * point_id] = min_cone_t0;
					surface_points_band_mp_interpolation[3 * point_id + 1] = min_cone_t1;
					surface_points_band_mp_interpolation[3 * point_id + 2] = 0;
					surface_points_band_mp_index[point_id] = min_cone_id;
				}
				else
				{
					mp_enclose_surface_points_index[ma_cones_num + min_slab_id].push_back(point_id);
					...
					surface_points_band_mp_interpolation[3 * point_id] = min_slab_t0;
					surface_points_band_mp_interpolation[3 * point_id + 1] = min_slab_t1;
					surface_points_band_mp_interpolation[3 * point_id + 2] = min_slab_t2;
					surface_points_band_mp_index[point_id] = ma_cones_num + min_slab_id;
				}
			}
		}
	}

	void PufferBallConfig::precomputeMedialPrimitiveBounding()
	{
	...
	void PufferBallConfig::uniform()
	{
		...
		center /= tet_nodes_num;

		double x = init_velocity[0];
		double y = init_velocity[1];
		Eigen::Vector3d hcent = Eigen::Vector3d(0, 5.0, -4.5);
		Eigen::Vector3d v = hcent - center;
		v.normalize();
		init_velocity = v * x;
		init_velocity += Eigen::Vector3d(0, -1.0, 0) * y;
	...
	void PufferBallConfig::computeSurfaceNormalAndBBox()
	{
	...
	void PufferBallConfig::computeMedialPrimitiveBBox()
	{
	...
	Eigen::Vector3d PufferBallConfig::getTetNodePosition(const uint32_t tid)
	{
		return Eigen::Vector3d(tet_nodes[3 * tid], tet_nodes[3 * tid + 1], tet_nodes[3 * tid + 2]);
	}

	Eigen::Vector3d PufferBallConfig::getSurfacePointsPosition(const uint32_t sid)
	{
		return Eigen::Vector3d(surface_points[3 * sid], surface_points[3 * sid + 1], surface_points[3 * sid + 2]);
	}

	Eigen::Vector3d PufferBallConfig::getMedialNodePosition(const uint32_t mid)
	{
		return Eigen::Vector3d(ma_nodes[4 * mid], ma_nodes[4 * mid + 1], ma_nodes[4 * mid + 2]);
	}

	double PufferBallConfig::getMedialNodeRadius(const uint32_t mid)
	{
		return ma_nodes[4 * mid + 3];
	}

	inline double PufferBallConfig::getNearestSphereOnMedialCone(const Eigen::Vector3d sc, const double sr, Eigen::Vector3d c11, double r11, Eigen::Vector3d c12, double r12, double & t)
	{
		bool inverse = false;
		if (r11 > r12)
		{
	...
	inline double PufferBallConfig::getNearestSphereOnMedialSlab(const Eigen::Vector3d sc, const double sr, const Eigen::Vector3d c11, const double r11, const Eigen::Vector3d c12, const double r12, const Eigen::Vector3d c13, const double r13, double & t1, double & t2)
	{
		Eigen::Vector3d cq = sc;
		double rq = sr;
